...
public abstract class FontTypeFace extends Rasterizer2D {
   ...
   int method5516(char var1) {
      ...
      return this.field3703[class166.charToByteCp1252(var1) & 255];
   }
      ...
      if(var1 == null) {
         ...
         for(int var5 = 0; var5 < var1.length(); ++var5) {
            ...
            if(var6 == '<') {
                     ...
                     if(!var7.equals("gt")) {
                        if(var7.startsWith("img=")) {
                           try {
                              ...
                              int var8 = class68.parseInt(var9, 10, true);
               ...
               if(var2 == -1) {
                  var4 += this.field3703[(char)(class166.charToByteCp1252(var6) & 255)];
            ...
            if(var15 == '<') {
               ...
               if(var15 == '>' && var10 != -1) {
                  ...
                  if(var16.equals("br")) {
                     ...
                     if(this.field3699 != null && var11 != -1) {
                        var4 += this.field3699[(var11 << '\b') + 60];
                     }
                     ...
                     var4 += this.method5516('>');
                     if(this.field3699 != null && var11 != -1) {
                        var4 += this.field3699[(var11 << '\b') + 62];
                     }
                     ...
                     try {
                        ...
                        int var17 = class68.parseInt(var18, 10, true);
               ...
               if(var10 == -1) {
                  if(var15 != 0) {
                     ...
                     if(this.field3699 != null && var11 != -1) {
                        var4 += this.field3699[var15 + (var11 << '\b')];
                     }
   ...
   public int method5519(String var1, int var2) {
      ...
      for(int var5 = 0; var5 < var3; ++var5) {
         int var6 = this.getTextWidth(field3710[var5]);
         if(var6 > var4) {
            var4 = var6;
         }
      }
   ...
   public int method5526(String var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10) {
      if(var1 == null) {
         ...
         for(var14 = 0; var14 < var12; ++var14) {
            if(var8 == 0) {
               this.drawText(field3710[var14], var2, var13);
            } else if(var8 == 1) {
               this.drawText(field3710[var14], var2 + (var4 - this.getTextWidth(field3710[var14])) / 2, var13);
            } else if(var8 == 2) {
               this.drawText(field3710[var14], var2 + var4 - this.getTextWidth(field3710[var14]), var13);
   ...
   void setRGB(String var1) {
      try {
         if(var1.startsWith("col=")) {
            color = class138.method3137(var1.substring(4), 16);
         } else if(var1.equals("/col")) {
            color = prevColorRGB;
         } else if(var1.startsWith("str=")) {
            strikeRGB = class138.method3137(var1.substring(4), 16);
         } else if(var1.equals("str")) {
            strikeRGB = 8388608;
         } else if(var1.equals("/str")) {
            strikeRGB = -1;
         } else if(var1.startsWith("u=")) {
            underlineRGB = class138.method3137(var1.substring(2), 16);
         } else if(var1.equals("u")) {
            underlineRGB = 0;
         } else if(var1.equals("/u")) {
            underlineRGB = -1;
         } else if(var1.startsWith("shad=")) {
            shadow = class138.method3137(var1.substring(5), 16);
   ...
   void method5533(String var1, int var2) {
      ...
      if(var3 > 0) {
         field3701 = (var2 - this.getTextWidth(var1) << 8) / var3;
      }
   ...
   void drawText(String var1, int var2, int var3) {
      ...
      for(int var6 = 0; var6 < var1.length(); ++var6) {
         if(var1.charAt(var6) != 0) {
            char var7 = (char)(class166.charToByteCp1252(var1.charAt(var6)) & 255);
            if(var7 == '<') {
               var4 = var6;
            } else {
               int var9;
                     ...
                     if(!var8.equals("gt")) {
                        if(var8.startsWith("img=")) {
                           try {
                              ...
                              var9 = class68.parseInt(var10, 10, true);
                              IndexedSprite var12 = modIcons[var9];
                              var12.method5829(var2, var3 + this.verticalSpace - var12.originalHeight);
               ...
               if(var4 == -1) {
                  ...
                  if(var7 != ' ') {
                     if(field3706 == 256) {
                        ...
                        if(shadow != -1) {
                           renderShadeRGBA(this.gylphs[var7], var2 + this.horizontalOffsets[var7] + 1, var3 + this.verticalOffsets[var7] + 1, var14, var9, shadow, field3706);
                        }

                        this.renderRGBA(this.gylphs[var7], var2 + this.horizontalOffsets[var7], var3 + this.verticalOffsets[var7], var14, var9, color, field3706);
                     }
                  } else if(field3701 > 0) {
                     field3705 += field3701;
                     var2 += field3705 >> 8;
                  ...
                  if(strikeRGB != -1) {
                     Rasterizer2D.method5736(var2, var3 + (int)((double)this.verticalSpace * 0.7D), var15, strikeRGB);
                  }

                  if(underlineRGB != -1) {
                     Rasterizer2D.method5736(var2, var3 + this.verticalSpace + 1, var15, underlineRGB);
                  }
   ...
   void drawMouseoverText(String var1, int var2, int var3, int[] var4, int[] var5) {
      ...
      for(int var9 = 0; var9 < var1.length(); ++var9) {
         if(var1.charAt(var9) != 0) {
            char var10 = (char)(class166.charToByteCp1252(var1.charAt(var9)) & 255);
            if(var10 == '<') {
               var6 = var9;
            } else {
               int var12;
                     ...
                     if(!var11.equals("gt")) {
                        if(var11.startsWith("img=")) {
                           try {
                              ...
                              var14 = class68.parseInt(var15, 10, true);
                              IndexedSprite var17 = modIcons[var14];
                              var17.method5829(var12 + var2, var13 + (var3 + this.verticalSpace - var17.originalHeight));
               ...
               if(var6 == -1) {
                  ...
                  if(var10 != ' ') {
                     if(field3706 == 256) {
                        ...
                        if(shadow != -1) {
                           renderShadeRGBA(this.gylphs[var10], var13 + var2 + this.horizontalOffsets[var10] + 1, var3 + var14 + this.verticalOffsets[var10] + 1, var19, var12, shadow, field3706);
                        }

                        this.renderRGBA(this.gylphs[var10], var13 + var2 + this.horizontalOffsets[var10], var3 + var14 + this.verticalOffsets[var10], var19, var12, color, field3706);
                     }
                  } else if(field3701 > 0) {
                     field3705 += field3701;
                     var2 += field3705 >> 8;
                  ...
                  if(strikeRGB != -1) {
                     Rasterizer2D.method5736(var2, var3 + (int)((double)this.verticalSpace * 0.7D), var20, strikeRGB);
                  }

                  if(underlineRGB != -1) {
                     Rasterizer2D.method5736(var2, var3 + this.verticalSpace, var20, underlineRGB);
                  }
