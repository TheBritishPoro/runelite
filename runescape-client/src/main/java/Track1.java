...
public class Track1 extends Node {
   ...
   Track1(Buffer var1) {
      ...
      Buffer var51 = new Buffer(this.field2546);
   ...
   void method4412() {
      if(this.field2547 == null) {
         this.field2547 = new HashTable(16);
         int[] var1 = new int[16];
         int[] var2 = new int[16];
         var2[9] = 128;
         var1[9] = 128;
               ...
               while(var7 == var4.field2525[var6]) {
                  ...
                  if(var9 == 144) {
                     ...
                     if(var12 > 0) {
                        ...
                        ByteArrayNode var14 = (ByteArrayNode)this.field2547.get((long)var13);
                        if(var14 == null) {
                           var14 = new ByteArrayNode(new byte[128]);
                           this.field2547.put(var14, (long)var13);
                        }
