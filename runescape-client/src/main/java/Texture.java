...
public class Texture extends Node {
   ...
   boolean method2661(double var1, int var3, IndexDataBase var4) {
      int var5;
      ...
      for(int var6 = 0; var6 < this.fileIds.length; ++var6) {
         IndexedSprite var7 = WorldMapDecorationType.method4589(var4, this.fileIds[var6]);
         var7.normalize();
   ...
   void method2657(int var1) {
      if(this.pixels != null) {
         ...
         if(this.field1537 == 1 || this.field1537 == 3) {
            if(field1541 == null || field1541.length < this.pixels.length) {
               field1541 = new int[this.pixels.length];
            }
            ...
            for(var6 = 0; var6 < var3; ++var6) {
               var7 = var6 + var4 & var5;
               field1541[var6] = this.pixels[var7];
            }

            var10 = this.pixels;
            this.pixels = field1541;
            field1541 = var10;
         }
         ...
         if(this.field1537 == 2 || this.field1537 == 4) {
            ...
            for(var6 = 0; var6 < var3; var6 += var2) {
               for(var7 = 0; var7 < var2; ++var7) {
                  ...
                  field1541[var8] = this.pixels[var9];
               }
            }
