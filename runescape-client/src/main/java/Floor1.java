...
public class Floor1 {
   ...
   Floor1() {
      int var1 = class92.getInt(16);
      if(var1 != 1) {
         throw new RuntimeException();
      } else {
         int var2 = class92.getInt(5);
         int var3 = 0;
         ...
         for(var4 = 0; var4 < var3; ++var4) {
            this.classDimensions[var4] = class92.getInt(3) + 1;
            var5 = this.classSubClasses[var4] = class92.getInt(2);
            if(var5 != 0) {
               this.classMasterbooks[var4] = class92.getInt(8);
            }
            ...
            for(var7 = 0; var7 < var5; ++var7) {
               var6[var7] = class92.getInt(8) - 1;
            }
         }

         this.multiplier = class92.getInt(2) + 1;
         var4 = class92.getInt(4);
         var5 = 2;
         ...
         this.field1287 = new int[var5];
         this.field1287[0] = 0;
         this.field1287[1] = 1 << var4;
         var5 = 2;
         ...
         for(var9 = 0; var9 < var2; ++var9) {
            ...
            for(int var8 = 0; var8 < this.classDimensions[var7]; ++var8) {
               this.field1287[var5++] = class92.getInt(var4);
            }
         }
   ...
   @ObfuscatedName("s")
   int method2118(int var1, int var2, int var3, int var4, int var5) {
      int var6 = var4 - var2;
      int var7 = var3 - var1;
   ...
   @ObfuscatedName("l")
   void method2119(int var1, int var2, int var3, int var4, float[] var5, int var6) {
      int var7 = var4 - var2;
      int var8 = var3 - var1;
      ...
      for(int var14 = var1 + 1; var14 < var3; ++var14) {
         ...
         var5[var14] *= field1283[var11];
      }

   }

   @ObfuscatedName("u")
   void method2135(int var1, int var2) {
      if(var1 < var2) {
         int var3 = var1;
         int var4 = xList[var1];
         int var5 = yList[var1];
         boolean var6 = field1293[var1];
         ...
         for(int var7 = var1 + 1; var7 <= var2; ++var7) {
            ...
            if(var8 < var4) {
               ...
               field1293[var3] = field1293[var7];
               ++var3;
               xList[var7] = xList[var3];
               yList[var7] = yList[var3];
               field1293[var7] = field1293[var3];
            }
         }
         ...
         yList[var3] = var5;
         field1293[var3] = var6;
         this.method2135(var1, var3 - 1);
         this.method2135(var3 + 1, var2);
      }
   }
   ...
   boolean decodedFloor() {
      ...
      if(!var1) {
         ...
         for(var3 = 0; var3 < var2; ++var3) {
            xList[var3] = this.field1287[var3];
         }

         var3 = RANGES[this.multiplier - 1];
         int var4 = class143.ilog(var3 - 1);
         yList[0] = class92.getInt(var4);
         yList[1] = class92.getInt(var4);
         int var5 = 2;
         ...
         for(int var6 = 0; var6 < this.paritionClassList.length; ++var6) {
            ...
            int var11 = 0;
            if(var9 > 0) {
               var11 = class92.codeBooks[this.classMasterbooks[var7]].getHuffmanRoot();
            }

            for(int var12 = 0; var12 < var8; ++var12) {
               int var13 = this.subclassBooks[var7][var11 & var10];
               var11 >>>= var9;
               yList[var5++] = var13 >= 0?class92.codeBooks[var13].getHuffmanRoot():0;
            }
         }
   ...
   void computeFloor(float[] var1, int var2) {
      ...
      for(var6 = 2; var6 < var3; ++var6) {
         var7 = method2120(xList, var6);
         var8 = method2117(xList, var6);
         var9 = this.method2118(xList[var7], yList[var7], xList[var8], yList[var8], xList[var6]);
         var10 = yList[var6];
         int var11 = var4 - var9;
         int var13 = (var11 < var9?var11:var9) << 1;
         if(var10 != 0) {
            boolean[] var14 = field1293;
            field1293[var8] = true;
            var14[var7] = true;
            field1293[var6] = true;
            if(var10 >= var13) {
            ...
            field1293[var6] = false;
            yList[var6] = var9;
         }
      }

      this.method2135(0, var3 - 1);
      var6 = 0;
      ...
      for(var8 = 1; var8 < var3; ++var8) {
         if(field1293[var8]) {
            ...
            this.method2119(var6, var7, var9, var10, var1, var2);
            if(var9 >= var2) {
               return;
            }
   ...
   @ObfuscatedName("z")
   static int method2120(int[] var0, int var1) {
      int var2 = var0[var1];
      int var3 = -1;
   ...
   @ObfuscatedName("w")
   static int method2117(int[] var0, int var1) {
      int var2 = var0[var1];
      int var3 = -1;
