...
codebase=http://oldschool30.runescape.com/
cachedir=oldschool
storebase=0
initial_jar=gamepack_1286481.jar
...
param=14=true
param=8=0
param=1=.runescape.com
param=13=330
param=2=30597
param=10=ElZAIrq5NpKN6D3mDdihco3oPeYN2KFy2DCquj7JMmECPmLrDP3Bnw
param=11=0
param=4=1
param=6=1
param=5=http://www.runescape.com/g=oldscape/slr.ws?order=LPWM
param=3=0
